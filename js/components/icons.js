 ...
 *
 * São os traçados do Lucide (ISC License) copiados direto para cá, em vez de
 * instalar o pacote: são 12 ícones, e assim não entra dependência nem requisição
 * extra (spec, seções 2 e 42). Para adicionar outro, copie o conteúdo do <svg>
 * do lucide.dev — o wrapper e os atributos de traço já estão padronizados aqui.
 */
 ...
 * O `size` vem em px; a cor é sempre herdada do texto (currentColor).
 */
...
/** Mesma coisa, já como elemento. */
export function iconElement(name, size = 20) {
